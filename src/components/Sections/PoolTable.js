                ...
                <>
                  <div className='table-responsive'>
                    ...
                    <CardSubtitle className='mb-3'>
                      The V1 pools have been retired; please unlock all your LP
                      tokens from the DAOVault (Dao - Lock+Earn) ASAP and then
                      remove all liquidity from all the pools to avoid losses
                      (These pools will eventually be destroyed; no guarantees
                      can be made that the assets will be returned to their
                      relevant liquidity provders)
                    </CardSubtitle>
                    <CardSubtitle className='mb-3'>
                      Also dont forget to claim your remaining bond LP tokens if you have any pending Bond positions (all positions have been fully unlocked)
                    </CardSubtitle>
                    <Table className='table-centered mb-0'>
                      <thead className='center'>
                        <tr>
                          <th scope='col'>
                            ...
                            <i
                              className='bx bx-info-circle ml-1 align-middle body'
                              id='priceHeader'
                              role='button'
                            />
                            <UncontrolledTooltip
                              ...
                              target='priceHeader'
                            >
                              Price of asset vs SPARTA in the pool
                            </UncontrolledTooltip>
                          </th>
                          ...
                          <th className='d-none d-lg-table-cell' scope='col'>
                            ...
                            <i
                              className='bx bx-info-circle ml-1 align-middle'
                              id='depthHeader'
                              role='button'
                            />
                            <UncontrolledTooltip
                              ...
                              target='depthHeader'
                            >
                              Total USD value of assets in the pool.
                              <br /> (SPARTA held in pool * 2 * PRICE)
                            </UncontrolledTooltip>
                          </th>
                          <th className='d-none d-lg-table-cell' scope='col'>
                            <h5 className='d-inline-block mb-0'>
                            ...
                            <UncontrolledTooltip
                              ...
                              target='volumeHeader'
                            >
                              Total value of all assets swapped in the pool.
                            </UncontrolledTooltip>
                          </th>
                          <th className='d-none d-lg-table-cell' scope='col'>
                            <h5 className='d-inline-block mb-0'>
                            ...
                            <UncontrolledTooltip
                              ...
                              target='txnsHeader'
                            >
                              Total count of add, remove & swap transactions.
                              <br />
                            </UncontrolledTooltip>
                          </th>
                          {/* <th className="d-none d-lg-table-cell" scope="col">
                      ...
                      <tbody>
                        {context.poolsData
                          .sort((a, b) =>
                            parseFloat(a.depth) > parseFloat(b.depth) ? -1 : 1
                          )
                          .map((c) => (
                            <PoolTableItem
                              key={c.address}

            ...
            <ul className='navbar-nav'>
              ...
              <li className='nav-item dropdown'>
                <Link to='#' className='nav-link dropdown-toggle arrow-none'>
                  <i className='bx bx-swim mr-2 align-middle' />
                  {props.t("Pools")}
                  <div className='arrow-down ml-1 align-middle'></div>
                </Link>
                <div className={classname("dropdown-menu")}>
                  <Link to='/pools' className='dropdown-item'>
                    <i className='bx bx-swim mr-1' />
                    {props.t("Pools")}
                  </Link>
                  <Link to='/positions' className='dropdown-item'>
                    <i className='mr-1 bx bx-trending-up' />
                    Positions
                  </Link>
                </div>
              </li>
              <li className='nav-item dropdown'>
                <Link to='#' className='nav-link dropdown-toggle arrow-none'>
                  <i className='bx bx-group mr-2 align-middle' />
                  {props.t("DAO")}
                  <div className='arrow-down ml-1 align-middle'></div>
                </Link>
                <div className={classname("dropdown-menu")}>
                  <Link to='/dao/lock' className='dropdown-item'>
                    <i className='mr-1 bx bx-lock' />
                    {props.t("Lock+Earn")}
                  </Link>
              ...
              <li className='nav-item dropdown'>
                <Link className='nav-link dropdown-toggle arrow-none' to='#'>
                  <i className='bx bx-info-circle mr-2 align-middle' />
                  {props.t("Info")}
                  <div className='arrow-down ml-1 align-middle'></div>
                </Link>
                <div className={classname("dropdown-menu")}>

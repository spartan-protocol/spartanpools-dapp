                                                ...
                                                <TabPane tabId="1">
                                                    ...
                                                    <Media className="faq-box mb-4">
                                                        ...
                                                        <Media body>
                                                            ...
                                                            <p className="text-muted">The project is galvanized by communities of former Binance Chain projects. The project begins decentralised from day 0, with no official team and no treasury.</p>
                                                        </Media>
                                                    </Media>
                                                    <Media className="faq-box mb-4">
                                                        <div className="faq-icon mr-3">
                                                        ...
                                                        <Media body>
                                                            ...
                                                            <p className="text-muted">That's a tough question but thankfully, our team is on it. Please bear with us while we're investigating. Yes, the Spartan Protocol is a community driven initiative with a wide and diverse source of contributors. It draws inspiration from THORchain and other projects that elected to go anonymous in line with the world’s most known token, Bitcoin.<br/><br/>
                                                                This is done to protect the project and its users to assist in ensuring it can be more decentralised from its outset. The focus should be on the project, code and the community that drives it, which are transparent and verifiable.
                                                    ...
                                                    <Media className="faq-box mb-4">
                                                        ...
                                                        <Media body>
                                                            ...
                                                            <p className="text-muted">Zero, zip, none, nada — like the 300 Spartans that held Hells Gate at Thermopylae, the team believe in the true intent of DeFi to provide open solutions for all on an EQUAL playing field.<br/><br/>
                                                                The only way for anyone to have access to the initial minting SPARTA tokens is by burning selected BEP20 tokens. This applies to everyone, there are no advantages given here. The Spartans believe the token will accrue value through genuine use and not through gimmicks.
                                                                The most important component of SP is that the team doesn’t have FREE skin in the game — if they want Sparta, they burn as well. There are no presale or private sale allocations waiting to be dumped.</p>
                                                        </Media>
                                                    </Media>
                                                    ...
                                                    <Media className="faq-box">
                                                        ...
                                                        <Media body>
                                                            ...
                                                            <p className="text-muted">Spartan Protocol starts decentralised from day one. To acquire SPARTA you will need to either send your tokens through a smart contract on the Spartan Protocol DApp, or purchase a previously minted SPARTA token on an exchange such as Binance.<br/><br/>
                                                                The tokens sent through the Smart Contract will be ‘burnt’ and will no longer be usable by anyone. The smart contract will then send your freshly minted SPARTA of equivalent value to your BSC address once the old tokens have been confirmed burned.<br/><br/>
                                                    ...
                                                    <Media className="faq-box">
                                                        ...
                                                        <Media body>
                                                            ...
                                                            <p className="text-muted">By burning your tokens to receive SPARTA, it shows an individual’s commitment to the project, every token has an inherent value associated with it set by the market.<br/><br/>
                                                                ...
                                                                We are not interested in anything resembling an ICO where valuations are manipulated. Besides, the community is confident they can provide the functionality discussed in the Whitepaper without a treasury.</p>
                                                        </Media>
                                                    </Media>
                                                    <Media className="faq-box">
                                                        <div className="faq-icon mr-3">
                                                        ...
                                                        <Media body>
                                                            ...
                                                            <p className="text-muted">There is no minimum qty! Binance Smart Chain fees are also very low allowing for smaller token holders to participate.<br/><br/>
                                                                However; the current MetaMask implementation REQUIRES AT LEAST 0.51 BNB in your wallet for the DApp to work properly! If MetaMask comes up with a crazy fees-price, then this is the issue, make sure you get more BNB in your wallet!</p>
                                                        </Media>
                                                    </Media>
                                                    <Media className="faq-box">
                                                        <div className="faq-icon mr-3">
                                                        ...
                                                        <Media body>
                                                            ...
                                                            <p className="text-muted">Yes, please make sure you have at least 0.51 BNB in your wallet to interact with MetaMask properly, if you are wishing the Burn for Sparta.<br/><br/>
                                                                You will use less than 0.05 BNB to pay for transactions, other operations and staking. BNB performs the same function as ETH for the Ethereum mainnet (aka 'gas')<br/><br/>
                                                                However one of the biggest differences is that Binance Smart Chain's fees are extremely low (and fast) compared to Ethereum! We are talking single digit cents, none of these $80-dollar Ethereum transactions when networks are congested!<br/><br/>
                                                                Liquidity providers have the choice to stake their tokens paired with SPARTA in an asymmetric fashion, however we highly recommend a clear understanding of how AMM protocols function in regards to asymmetric liquidity provision, as not all AMM protocols function the same way.</p>
                                                        </Media>
                                                    </Media>
                                                </TabPane>
